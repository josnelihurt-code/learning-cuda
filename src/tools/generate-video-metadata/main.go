...
const outputTemplate = `// Code generated by src/tools/generate-video-metadata. DO NOT EDIT.
//
...
func main() {
	...
	outputFile := "src/go_api/pkg/infrastructure/video/test_video_metadata.go"
